...
void mini_list_show_raw(mini_list_head_t *head)
{
	...
	while (current != head) {
		//mini_task_t *task = mini_container_of(current, mini_task_t, task_node);
